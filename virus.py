...
print
print ("\033[49m                   Welcome LAC...                        \033[0m")
print ("\033[48m                   Author: Labib Mirza                   \033[0m")
print
...
def help():
  print
  print ("\033[44m Developer : Labib Mirza\033[0m")
  print ("\033[44m Program : Virus\033[0m")
  ...
  if dr == "show options":
    ...
    ###########
		...
		if android == "run":
			...
			time.sleep(1)
			os.system("cd virus;mkdir Antivirus;cd Antivirus;wget https://github.com/labibhacker/android-malware/raw/master/unclassified_apks/DroidXAntivirus.apk")
			print
			print "Now check folder Virus on "+R+"/virus/virus/Antivirus/"+N+""
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "01":
		...
		if rez == "run":
			...
			print
			print "Now check folder virus on"+R+" /virus/virus/freeze/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/virus/virus/Wannadecryptor/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/virus/virus/sms_tief/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			main()
  elif dr == "07":
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/virus/virus/malware_enc/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/virus/virus/malware_bnews/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
    ...
    time.sleep(6)
    os.system("cd ..;rm -rf virus;git clone https://github.com/labibhacker/virus;cd virus;python2 virus.py")
    main()
  elif dr == "10":
    time.sleep(1)
    print ""+R+"exiting..."
